...
console.log("Прочитано первое сообщение?: " + readMessages.has(messages[0]));
console.log("Прочитано второе сообщение?: " + readMessages.has(messages[1]));
console.log("Прочитано третье сообщение?: " + readMessages.has(messages[2]));